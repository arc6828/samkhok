function autocomplete(inp, arr) {
  ...
  inp.addEventListener("input", function (e) {
    ...
    for (i = 0; i < arr.length; i++) {
      ...
      //   console.log(arr);
      let index_found = arr[i][content_key]
        // .substr(0, val.length)
        .indexOf(val);
      //   let found =
      //     arr[i][content_key].substr(0, val.length).toUpperCase() ==
      //     val.toUpperCase();
      ...
      if (index_found >= 0) {
        ...
        b_title = document.createElement("DIV");
        b_title.innerHTML = arr[i]["title"];
        b.innerHTML += "";
        ...
        b.innerHTML +=
          "<strong>" +
          arr[i][content_key].substr(index_found, val.length) +
          "</strong>";
        ...
        // b.innerHTML +="<input type='hidden' value='" + arr[i][content_key] + "'>";
        ...
        a.appendChild(b);
        // b_container.appendChild(b);
        // b_container.appendChild(b_title);
      }
    }
  });
